...
<script>
    ...
    <div class="tab">
        ...
        <a href="vacation_table.jsp" style="color:black;" class="active">vacation Table</a>
                    ...
                    <tr>
                        ...
                        %>
                         ...
                         <%
                          ...
                          %>
                            <form method="POST" action="http://localhost:8080/MAJOR_PROJECT/vacation_delete?email=<%=ors.getString(5)%>"  onsubmit=" return funDelete()">
                                    <td>
