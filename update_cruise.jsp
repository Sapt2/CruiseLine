    ...
    <body style="background:url('../images/form_back.jpg') no-repeat;background-size: cover;">
        <%
           ...
           <div class="update">
            ...
            <form action="http://localhost:8080/MAJOR_PROJECT/update_process_cruise" method="POST">
                    ...
                    <%
                        ...
                        while(ors.next())
                        {
                             %>
                                ...
                                <input type="text"  name="start_port" value="<%=ors.getString(2)%>">
                                <br>
                                <label>Destination<label>
                                <input type="text"  name="destination" value="<%=ors.getString(3)%>">
                                <br>
                                <label>Dates<label><br>
                                <input type="text"  name="dates" value="<%=ors.getString(4)%>">
                                <br>
                                <label>Ship Name<label>
                                <input type="text"  name="ship_name" value="<%=ors.getString(5)%>">
                                <br>
                                <label>cruise Type<label>
                                <input type="text"  name="cruise_type" value="<%=ors.getString(6)%>">
                                <br>
                                <label>Cruiseliner<label>
                                <input type="text"  name="cruiseliner" value="<%=ors.getString(7)%>">
                                <br>
