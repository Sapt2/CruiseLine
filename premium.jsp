                  ...
                  <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                      ...
                      <div id="panelsStayOpen-collapseThree" class="accordion-collapse" aria-labelledby="panelsStayOpen-headingThree">
                        ...
                        <a href="premium.jsp" style="color:black;">> Premium</a><br>
...
<!--PACKAGE_3-->
          ...
          <div class="row">
          <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
            <img src="../images/p3.jpg" class="img-fluid" width="100%" alt="...">
            <div class="details p-3" id="detail">
                
              <input type="text" class="package_tag" name="tag" readonly 
                value=" 2 Nights Mumbai to Goa Return Inaugural Sailing">
              <input type="text" class="dest" name="dest" readonly 
                value="Destination : India">
              <input type="text" class="from" name="from" readonly 
                value="From Mumbai, India">
              <br><br><br>
              ...
              <i class="fas fa-ship"></i><small class="detail"> Cruise Type : Premium Cruise</small><br>
              <i class="fa-solid fa-anchor"></i><small class="detail"> Cruiseliner : Oberoi </small>
              <br><br><br>
              
              <p style="color:rgb(82, 72, 72);font-size: 20px;">2 PORTS OF CALL</p><br>
              <small class="detail">Goa; Mumbai</small>
            </div>
            </div>
          ...
          <div class="col-md-4" style="padding-left: 0px;">
            <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
              <small>From</small><br>
              <input type="text" class="price" name="price" readonly 
                value="$1,520"><sub class="price-sub">PP/USD</sub><hr>
              <p class="card-text">Enjoy fun filled vacation in tourist paradise of U.A.E. for 03 nights in Dubai and 01  holiday await you on board.</p>
              
              <input type="text" name="val" value="INDIA_P3" hidden>
...
<!--PACKAGE_5-->
          ...
          <div class="row">
          <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
            <img src="../images/card3.jpg" class="img-fluid" width="100%" alt="...">
            <div class="details p-3" id="detail">
                
              <input type="text" class="package_tag" name="tag" readonly 
                value="9-DAY CRUISE ON ANTARA CRUISES">
              <input type="text" class="dest" name="dest" readonly 
                value="Destination : India">
              <input type="text" class="from" name="from" readonly 
              ...
              <i class="fas fa-calendar-week"></i><small class="detail"> Sailing Oct, 2023</small><br>
              <i class="fa fa-water"></i><small class="detail"> Ship Name : The Intex</small><br>
              <i class="fas fa-ship"></i><small class="detail"> Cruise Type : Premium Cruise</small><br>
              <i class="fa-solid fa-anchor"></i><small class="detail"> Cruiseliner : MSC Cruises</small>
              <br><br><br>
              
              <p style="color:rgb(82, 72, 72);font-size: 20px;">12 PORTS OF CALL</p><br>
              <small class="detail">Bandel; Bansbera; Belur Math, Kolkata; Bony Camp, Sunderbans; Chandannagar; Do Banki; Kolkata; Namkhana; Serampore, Kolkata; Sudhanyakhali</small>
            </div>
            </div>
          ...
          <div class="col-md-4" style="padding-left: 0px;">
            <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
              <small>From</small><br>
              <input type="text" class="price" name="price" readonly 
                value="$1,020"><sub class="price-sub">PP/USD</sub></h3><hr>
              <p class="card-text">Enjoy fun filled vacation in tourist paradise of U.A.E. for 03 nights in Dubai and 01  holiday await you on board.</p>
              
              <input type="text" name="val" value="INDIA_P5" hidden >
              <input type="submit" class="btn btn-warning" value="BOOK NOW">
...
<!--PACKAGE_2-->
            <div class="card mb-4 box-design" style="max-width: 100%;">
                ...
                <div class="row">
                    <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
                        <img src="../images/north_america(4).jpg" class="img-fluid" width="100%" alt="...">
                        <div class="details p-3" id="detail">
                            <input type="text" class="package_tag" name="tag" readonly 
                value="5 Nights Bermuda Cruise from New York">
              <input type="text" class="dest" name="dest" readonly 
                value="Destination : North America">
              <input type="text" class="from" name="from" readonly 
                value="From New York, USA">
              <br><br><br>                            
              <i class="fas fa-calendar-week"></i><small> Sailing November 5, 2023</small><br>
<i class="fa fa-water"></i><small class="detail"> Ship Name : Norwegian Escape</small><br>
              <i class="fas fa-ship"></i><small class="detail"> Cruise Type : Premium Cruises</small><br>
              <i class="fa-solid fa-anchor"></i><small class="detail"> Cruiseliner : Oberoi</small><br><br><br>                            
              <p style="color:rgb(82, 72, 72);font-size: 20px;">2 PORTS OF CALL</p>
              <small class="detail">
                 New York; Royal Naval Dockyard
              </small>
                    ...
                    <div class="col-md-4" style="padding-left: 0px;">
                        <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
                            <small>From</small><br>
                            <input type="text" class="price" name="price" readonly 
                value="$1,052"><sub>PP/USD</sub><hr>
                            <p class="card-text">Enjoy fun filled vacation in tourist paradise of U.A.E. for 03 nights in Dubai and 01  holiday await you on board.</p>
                            
                                <input type="text" name="val" value="NORTH_AMERICA_P2" hidden>
                                <input type="submit" class="btn btn-warning" name="button1" value="BOOK NOW">
            ...
            <div class="card mb-4 box-design" style="max-width: 100%;">
                ...
                <div class="row">
                    <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
                        <img src="../images/north_america(7).jpg" class="img-fluid" width="100%" alt="...">
                        <div class="details p-3" id="detail">
                            <input type="text" class="package_tag" name="tag" readonly 
                value="6-Day Canada & New England from New York, NY">
              <input type="text" class="dest" name="dest" readonly 
                value="Destination : North America">
              <input type="text" class="from" name="from" readonly 
                value="New York, USA">
              <br><br><br>
                            <i class="fas fa-calendar-week"></i><small> Sailing september , 2023</small><br>
<i class="fa fa-water"></i><small class="detail"> Ship Name : Carnival Venezia</small><br>
              <i class="fas fa-ship"></i><small class="detail"> Cruise Type : Premium Cruises</small><br>
              <i class="fa-solid fa-anchor"></i><small class="detail"> Cruiseliner : Silversea</small><br><br><br>                            <small style="color:rgb(82, 72, 72)"> PORTS OF CALL</small><br>
              <p style="color:rgb(82, 72, 72);font-size: 20px;">5 PORTS OF CALL</p>
              <small class="detail">
                 Halifax; New York; Portland; Saint John, New Brunswick (Bay of Fundy)
              </small>  
                    ...
                    <div class="col-md-4" style="padding-left: 0px;">
                        <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
                            <small>From</small><br>
                            <input type="text" class="price" name="price" readonly 
                value="$459"><sub>PP/USD</sub><hr>
                            <p class="card-text">Enjoy fun filled vacation in tourist paradise of 
                                U.A.E. for 03 nights in Dubai and 01  holiday await you on board.</p>
                            <input type="text" name="val" value="NORTH_AMERICA_P3" hidden>
           ...
           <form method="POST" action="north_america_package.jsp">
                ...
                <div class="row">
                <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
                    <img src="../images/north_america(12).png" class="img-fluid" width="100%" alt="...">
                    <div class="details p-3" id="detail">
                    <input type="text" class="package_tag" name="tag" readonly 
                value="  4-Day Canada & New England from New York, NY">
              <input type="text" class="dest" name="dest" readonly 
                value="Destination : North America">
              <input type="text" class="from" name="from" readonly 
                value="New York, USA">
              <br><br><br>
              <i class="fas fa-calendar-week"></i><small> Sailing August, 2023</small><br>
<i class="fa fa-water"></i><small class="detail"> Ship Name : Carnival Venezia</small><br>
              <i class="fas fa-ship"></i><small class="detail"> Cruise Type : Premium Cruises</small><br>
              <i class="fa-solid fa-anchor"></i><small class="detail"> Cruiseliner : Ponant</small><br><br><br>                 <small style="color:rgb(82, 72, 72)">PORTS OF CALL</small><br>
              <p style="color:rgb(82, 72, 72);font-size: 20px;">3 PORTS OF CALL</p>
              <small class="detail">
                 New York; Saint John, New Brunswick (Bay of Fundy)
              </small>
          ...
          <div class="col-md-4" style="padding-left: 0px;">
            <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
              <small>From</small><br>
              <input type="text" class="price" name="price" readonly 
                value="$469"><sub>PP/USD</sub><hr>
              <p class="card-text">Enjoy fun filled vacation in tourist paradise of U.A.E. for 03 nights in Dubai and 01  holiday await you on board.</p>
                  <input type="text" name="val" value="NORTH_AMERICA_P4" hidden>
              <input type="submit" class="btn btn-warning" name="button1" value="BOOK NOW">
