          ...
          <div class="accordion" id="accordionPanelsStayOpenExample">
              ...
              <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseTwo" class="accordion-collapse" aria-labelledby="panelsStayOpen-headingTwo">
                  <div class="accordion-body">
                        <a href="CRUISELINER_OBEROI.jsp" style="color:black;">> OBEROI</a><br>
        ...
        <div class="row">
          <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
            ...
            <div class="details p-3" id="detail">
              ...
              <small class="detail">Baie St. Anne, Praslin; Felicite; Inter-island Quay - Mahe; La Digue; Moyenne Island</small>
            </div>
            </div>
          ...
          <div class="col-md-4" style="padding-left: 0px;">
            <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
              ...
              <input type="text" name="val" value="AFRICA_P1" hidden>
      ...
      <!--PACKAGE_2-->
        ...
        <div class="row">
          <div class="col-md-8 h" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
            <img src="../images/aus1.webp" class="img-fluid" width="100%" height="200%" alt="...">
            <div class="details p-3" id="detail">
              <input type="text" class="package_tag" name="tag" readonly 
                value="13 Nights Fiji & Tonga Cruise from Sydney">
              <input type="text" class="dest" name="dest" readonly 
                value="Destination : Australia">
              <input type="text" class="from" name="from" readonly 
                value="From Sydney, Australia">
              <br><br><br>
              <i class="fas fa-calendar-week"></i><small class="detail"> Sailing November, 2023</small><br>
              <i class="fa fa-water"></i><small class="detail"> Ship Name : Celebrity Eclipse</small><br>
              <i class="fas fa-ship"></i><small class="detail"> Cruise Type : Luxury Cruise</small><br>
              <i class="fa-solid fa-anchor"></i><small class="detail"> Cruiseliner : Oberoi</small><br><br><br>
              <p style="color:rgb(82, 72, 72);font-size: 20px;">14 PORTS OF CALL</p><br>
              <small class="detail">Sydney: Australia; Noumea, New Calendonia; Suva: Fiji; Lautoka: Fiji; Nuku Alofa, Tonga; Mystry Island: Vanuatu</small>
            </div>
            </div>
          ...
          <div class="col-md-4" style="padding-left: 0px;">
            <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
                <small >From</small><br>
                <input type="text" class="price" name="price" readonly 
                value="$1,786"><sub class="price-sub">PP/USD</sub><hr>
              <p class="card-text">Enjoy fun filled vacation in tourist paradise of U.A.E. for 03 nights in Dubai and 01  holiday await you on board.</p>
              <input type="text" name="val" value="AUSTRALIA_P1" hidden>
              <input type="submit" class="btn btn-warning" name="button1" value="BOOK NOW">
        ...
        <div class="row">
        <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
          <img src="../images/africa3.jpeg" class="img-fluid" width="100%" alt="...">
          <div class="details p-3" id="detail">
            <input type="text" class="package_tag" name="tag" readonly 
            value=" 4 Nights Cruise Luxor to Aswan">
          <input type="text" class="dest" name="dest" readonly 
            value="Destination : Africa">
          <input type="text" class="from" name="from" readonly 
            value="From Luxor,Egypt">
          <br><br><br>
            ...
            <small class="detail">Aswan; Edfu; Essna; Kom Ombo; Luxor</small>
          </div>
          </div>
        ...
        <div class="col-md-4" style="padding-left: 0px;">
          <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
            ...
            <input type="text" class="price" name="price" readonly 
              ...
              <sub class="price-sub">PP/USD</sub><hr>
            <p class="card-text">Enjoy fun filled vacation in tourist paradise of U.A.E. for 03 nights in Dubai and 01  holiday await you on board.</p>
            <input type="text" name="val" value="AFRICA_P3" hidden>
        ...
        <div class="row">
        <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
          <img src="../images/africa5.jpeg" class="img-fluid" width="100%" alt="...">
          <div class="details p-3" id="detail">
            <input type="text" class="package_tag" name="tag" readonly 
            value=" 7 Nights Cruise Luxor to Aswan">
          <input type="text" class="dest" name="dest" readonly 
            value="Destination : Africa">
          <input type="text" class="from" name="from" readonly 
            value="From Luxor,Egypt">
          <br><br><br>
            ...
            <i class="fa-solid fa-anchor"></i><small class="detail"> Cruiseliner : Oberoi</small><br><br><br>
            <p style="color:rgb(82, 72, 72);font-size: 20px;">6 PORTS OF CALL</p><br>
            <small class="detail">Abu Simbel; Aswan; Edfu; Essna; Kom Ombo; Luxor; Quina</small>
          </div>
          </div>
        ...
        <div class="col-md-4" style="padding-left: 0px;">
          <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
            ...
            <input type="text" class="price" name="price" readonly 
              ...
              <sub class="price-sub">PP/USD</sub><hr>
            <p class="card-text">Enjoy fun filled vacation in tourist paradise of U.A.E. for 03 nights in Dubai and 01  holiday await you on board.</p>
            <input type="text" name="val" value="AFRICA_P5" hidden>
