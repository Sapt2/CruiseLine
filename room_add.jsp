...
<body style="height:auto;">
    ...
    <a href="dashboard.jsp" >Admin Table</a>
       ...
       <a href="room_add.jsp" style="color:black;" class="active">Room Add</a>
...
<i class="fa-solid fa-right-from-bracket" style="color: #fdfcfc;"></i>
    ...
    <form method="POST" name="frmRegister" action="http://localhost:8080/MAJOR_PROJECT/room_add">
    <div class="form-box">
        <h1 id="title">ADD NEW ROOM</h1>
        <div class="input-group" id="ingroup">
            <div class="input-field">   
                    <input type="text" required placeholder="package" name="package">
                </div>
            <div class="input-field">   
                    <input type="text" required placeholder="room" name="room">
                </div>
                
    <div class="input-field">
    <input type="text" id="nameField" required placeholder="amount" name="amount">
    </div>
