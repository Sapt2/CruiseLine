<%-- 
    Document   : update
    Created on : 15-May-2023, 18:17:24
    Author     : risit
--%>
...
#submit_button{
    ...
    <body style="background:url('../img/form_bk.jpeg') no-repeat center;backgroung-size:cover;object-fit: cover;">
        <%
            ...
            //STEP 1 : REGISTERING OF THE REQUIRED DRIVER WITH THE JAVA PROGRAM
                ...
                q = "SELECT * from USERSS where email=?";
      ...
      <div class="row">
           <div class="update">
            ...
            <form action="http://localhost:8080/cruise/update_process_user" method="POST">
                    ...
                    <%
                        ...
                        while(ors.next())
                        {
                             %>
                                <label>Id</label>
                                <input type="text"  name="email" value="<%=ors.getString(1)%>" readonly>
                                <br>
                                <label>Email<label>
                                <input type="text"  name="ph_no" value="<%=ors.getString(2)%>">
                                <br>
                                <label>Name<label>
                                <input type="text"  name="name" value="<%=ors.getString(3)%>">
                                <br>
                                <label>DOB<label>
                                <input type="text"  name="dob" value="<%=ors.getString(4)%>">
                                <br>
                                <label>Country<label>
                                <input type="text"  name="country" value="<%=ors.getString(5)%>">
                                <br>
                ...
                %>
                    ...
                    <div class="image">
                        <img src="../img/admin.png" style="width: 30%;">
                    </div>
     </div>
    </body>
</html>
