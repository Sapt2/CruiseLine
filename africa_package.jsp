...
<html>
  ...
  <div class="container-fluid image"  style="padding: 0px;">
      <img src="../images/africa_package.jpeg" class="img-fluid" width="100%" height="30%"
...
<div style="float:right; width: 35%;"><hr/></div>
    <center><h3 class="pb-3" style="font-family: 'Poppins', sans-serif; font-weight: 700;">Just another day in Paradise</h3></center>
  <!--TABLE-->
            ...
            <div class="container-fluid">
                <div class="row pt-5" style="margin: 3px 50px;">
                    <div class="col-md-8" data-aos="zoom-in-down" data-aos-duration="2000">
                            <div class="card mb-4" style="max-width: 100%;">
                                <div class="card-body" >
                                    ...
                                    <small>When traveling with your family, you’ve got space on your mind. An Interior Room is our most cozy, budget-friendly option, and we offer Spacious Interiors, along with connecting rooms to accommodate larger families. The range of ultra-spacious cruise rooms across categories spans all the way up to our new Ultimate Family Suite — two full stories that elevate the way you stay and play.
                                    </small><hr>
                    ...
                    <div class="col-md-4 img" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/hot1.jpg" class="img-fluid">
                ...
                <div class="row pt-1" style="margin: 2px 50px;" data-aos="zoom-in-down" data-aos-duration="2000">
                    <div class="col-md-8">
                        <img src="../images/hot2.jpg" class="img-fluid" width="100%" height="50%">
<!--                        <div class="bottom-left">SUIT</div>-->
                    </div>
                    <div class="col-md-4">
                        <img src="../images/hot5.jpg" class="img-fluid">
<!--                        <div class="bottom-left">OCEANVIEW</div>-->
                ...
                <div class="row pt-4" style="margin: 3px 50px;">
                    <div class="col-md-4" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/hot3.jpg" class="img-fluid">
<!--                        <div class="bottom-left">SUIT</div>-->
                    </div>
                    <div class="col-md-8" data-aos="zoom-in-down" data-aos-duration="2000">
