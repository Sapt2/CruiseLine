...
<div class="container-fluid" style="padding-left: 40px;padding-right: 40px;">
 ...
 <a href="CRUISELINER_OBEROI.jsp">> OBEROI</a><br>
                        ...
                        <a href="cruiseliner_msc_cruises.jsp" style="color:black;">> MSC CRUISES</a><br>
                                              </ul>                  </div>
                </div>
              </div>
              <div class="accordion-item">
      ...
      <div class="card mb-4 box-design" style="max-width: 100%;">
          ...
          <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
            <img src="../images/aus3.webp" class="img-fluid" width="100%" alt="...">
            <div class="details p-3" id="detail">
              <input type="text" class="package_tag" name="tag" readonly 
              value="11 Night New Zealand Cruise">
            ...
            <br><br><br>
              ...
              <i class="fa fa-water"></i><small class="detail"> Ship Name : Celebrity Solistice</small><br>
              <i class="fas fa-ship"></i><small class="detail"> Cruise Type : Family Cruises</small><br>
              ...
              <small class="detail">Auckland:New Zealand; Napier, Picton, Dunedin, Dusky Sound, Eden, Sydney:Australia</small>
            </div>
            </div>
          ...
          <div class="col-md-4" style="padding-left: 0px;">
            <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
              ...
              <input type="text" class="price" name="price" readonly 
                value="$2,326"><sub class="price-sub">PP/USD</sub><hr>
              ...
              <input type="text" name="val" value="AUSTRALIA_P3" hidden>
    ...
    <div class="card mb-4 box-design" style="max-width: 100%;">
       ...
       <div class="card mb-4 box-design" style="max-width: 100%;">
                ...
                <div class="row">
                <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
                    <img src="../images/hawai(4).jpg" class="img-fluid" width="100%" alt="...">
                    <div class="details p-3" id="detail">
                  <input type="text" class="package_tag" name="tag" readonly 
                value="  12-DAY CRUISE ON NORWEGIAN SPIRIT">
              <input type="text" class="dest" name="dest" readonly 
                value="Destination : Kauai, Maui">
              <input type="text" class="from" name="from" readonly 
                value="From Papeete, Tahiti, French Polynesia"><br><br><br>
              <i class="fas fa-calendar-week"></i><small class="detail"> Sailing : September, 2023
</small><br>
             <i class="fa fa-water"></i><small class="detail"> Ship Name : Carnival Venezia</small><br>
              ...
              <i class="fa-solid fa-anchor"></i><small class="detail"> Cruiseliner : MSC Cruises</small><br><br><br>
               ...
               <p style="color:rgb(82, 72, 72)" font-size: 20px;">7 PORTS OF CALL</p>
...
N?wiliwili</small>
          ...
          <div class="col-md-4" style="padding-left: 0px;">
            <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
                <small>From</small><br>
               <input type="text" class="price" name="price" readonly 
                value="$1,452"><sub class="price-sub">PP/USD</sub><hr>
              <p class="card-text">Enjoy fun filled vacation in tourist paradise of U.A.E. for 03 nights in Dubai and 01  holiday await you on board.</p>
              <input type="text" name="val" value="HAWAII_P4" hidden>
