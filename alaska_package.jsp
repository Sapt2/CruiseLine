...
<html>
  ...
  <div class="container-fluid image"  style="padding: 0px;">
      <img src="../images/alaska_package.jpeg" class="img-fluid" width="100%" height="30%"
  ...
  <div class="container-fluid">
                    <div class="row" style="margin: 3px 60px;">
                        <div class="col-md-8" data-aos="fade-left" data-aos-duration="2000">
                            ...
                            <p>
                                Alaska is one of the most popular cruise destinations in the world. One of North America’s last great true frontiers, it is an overwhelming landscape of stunning glaciers and endless forests, towering mountains and isolated villages, abundant wildlife and a coastline that is one of the most enthralling waterways in the world. With activities and tours that range from the mild to the wild, Alaska has something for everyone. Explore the beauty of the Inside Passage, admire the spectacular sights of the glaciers of College Fjord, Tracy Arm Fjord and the Glacier Bay National Park.
                            </p>
                        </div>
...
<div style="float:right; width: 35%;"><hr/></div>
    <center><h3 class="pb-3" style="font-family: 'Poppins', sans-serif; font-weight: 700;">Let the good times roll!</h3></center>
  <!--TABLE-->
            ...
            <div class="container-fluid">
                <div class="row pt-5" style="margin: 3px 50px;">
                    <div class="col-md-4 img" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/hot8.jpg" class="img-fluid">
                        
                    </div>
                    <div class="col-md-8" data-aos="zoom-in-down" data-aos-duration="2000">
                            <div class="card mb-4" style="max-width: 100%;">
                                <div class="card-body" >
                                    <h3>Awe Inspiring Accommodation</h3>
                                    <small>Beyond the basics, you’ll find rooms that take your vacation to the next level — we’re talking stuff that matters most to groups, families, folks with special needs and more! Adding friends equals multiplying the fun. That’s why many Carnival staterooms can be configured in different ways — some sleep up to five!
                                    </small><hr>
                ...
                <div class="row pt-1" style="margin: 2px 50px;" data-aos="zoom-in-down" data-aos-duration="2000">
                    <div class="col-md-4">
                        <img src="../images/hot6.jpg" class="img-fluid">
<!--                        <div class="bottom-left">OCEANVIEW</div>-->
                    </div>
                    <div class="col-md-8">
                        <img src="../images/hot12.jpeg" class="img-fluid" width="100%" height="50%">
<!--                        <div class="bottom-left">SUIT</div>-->
                ...
                <div class="row pt-4" style="margin: 3px 50px;">
                    <div class="col-md-8" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/hot4.jpg" class="img-fluid">
<!--                        <div class="bottom-left">OCEANVIEW</div>-->
                    </div>
                    <div class="col-md-4" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/hot7.jpg" class="img-fluid">
<!--                        <div class="bottom-left">SUIT</div>-->
                    </div>
