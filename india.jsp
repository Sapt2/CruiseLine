  ...
  <div class="row mt-3 mb-3">
              ...
              <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseOne" class="accordion-collapse" aria-labelledby="panelsStayOpen-headingOne">
                  <div class="accordion-body">
                        <a href="india.jsp" style="color:black;">> India</a><br>
      ...
      <div class="col-md-9">
        ...
        <div class="row">
          ...
          <div class="row">
          <div class="col-md-8" style="padding-right:0px;position:relative;" data-aos="zoom-in" data-aos-duration="2000">
            <img src="../images/p1.jpg" class="img-fluid" width="100%" alt="...">
            <div class="details p-3" id="detail">
                
              <input type="text" class="package_tag" name="tag" readonly 
                value="3 Nights Goa, Lakshadweep to Mumbai Cruise">
              <input type="text" class="dest" name="dest" readonly 
                value="Destination : India">
              <input type="text" class="from" name="from" readonly 
                value="From Mormugao, Goa, India">
              <br><br><br>
              
              <i class="fas fa-calendar-week"></i><small class="detail"> Sailing June, 2023</small><br>
              ...
              <i class="fa-solid fa-anchor"></i><small class="detail"> Cruiseliner : Ponant</small>
              <br><br><br>
              
              <p style="color:rgb(82, 72, 72);font-size: 20px;">4 PORTS OF CALL</p><br>
              <small class="detail">Lakshadweep (Kadmat); Mormugao, Goa; Mumbai</small>
            </div>
            </div>
          ...
          <div class="col-md-4" style="padding-left: 0px;">
            <div class="card-body" data-aos="fade-left" data-aos-duration="2000">
              <small>From</small><br>
              <input type="text" class="price" name="price" readonly 
                value="$2,140"><sub class="price-sub">PP/USD</sub></h3><hr>
              <p class="card-text">Enjoy fun filled vacation in tourist paradise of U.A.E. for 03 nights in Dubai and 01  holiday await you on board.</p>
              
              <input type="text" name="val" value="INDIA_P4"hidden >
              <input type="submit" class="btn btn-warning" value="BOOK NOW">
