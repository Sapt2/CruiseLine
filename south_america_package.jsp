...
<html>
  ...
  <div class="container-fluid image"  style="padding: 0px;">
      <img src="../images/s.jpg" class="img-fluid" width="100%" height="30%"
           data-aos="fade-down" data-aos-duration="2000">
  </div>
  <!--BACK BUTTON-->
  <div class="container-fluid p-3" style="margin-left: 68px;">
      <a href="south_america.jsp">
                    ...
                    <div class="row" style="margin: 3px 60px;">
                        <div class="col-md-8" data-aos="fade-left" data-aos-duration="2000">
                            ...
                            <h4 style="color:rgb(82, 72, 72)"><%out.println(f);%></h4>
                                                        <p>Choose from distinct South American cruise itineraries that will take you places far beyond your imagination. From ancient civilizations to dramatic vistas of rushing waterfalls, South America cruises make an impression. Browse our South American cruises with the Best Cruise Line in South America according to Cruise Critic, and start planning your next great holiday.                            </p>
...
<div style="float:right; width: 35%;"><hr/></div>
    <center><h3 class="pb-3" style="font-family: 'Poppins', sans-serif; font-weight: 700;">
            Sample the world’s finest cruises</h3></center>
  <!--TABLE-->
    ...
    <!--NEED TO KNOW-->
            ...
            <div class="container-fluid">
                ...
                <div class="row pt-1" style="margin: 2px 50px;" data-aos="zoom-in-down" data-aos-duration="2000">
                    <div class="col-md-8">
                        <img src="../images/south_room(2).jpg" class="img-fluid" width="100%" height="50%">
<!--                        <div class="bottom-left">SUIT</div>-->
                    </div>
                    <div class="col-md-4">
                        <img src="../images/south_room(3).jpg" class="img-fluid">
<!--                        <div class="bottom-left">OCEANVIEW</div>-->
                ...
                <div class="row pt-4" style="margin: 3px 50px;">
                    <div class="col-md-4" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/south_room(4).jpg" class="img-fluid">
<!--                        <div class="bottom-left">SUIT</div>-->
                    </div>
                    <div class="col-md-8" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/south_room(5).jpg" class="img-fluid">
<!--                        <div class="bottom-left">OCEANVIEW</div>-->
                    </div>
                </div>
            </div>
