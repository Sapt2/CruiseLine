...
<html>
  ...
  <div class="container-fluid image"  style="padding: 0px;">
      <img src="../images/australia_package.jpeg" class="img-fluid" width="100%" height="30%"
           data-aos="fade-down" data-aos-duration="2000">
  </div>
  <!--BACK BUTTON-->
  <div class="container-fluid p-3" style="margin-left: 68px;">
      <a href="australia.jsp">
...
<div style="float:right; width: 35%;"><hr/></div>
    <center><h3 class="pb-3" style="font-family: 'Poppins', sans-serif; font-weight: 700;">It's time to Sea the World</h3></center>
  <!--TABLE-->
    ...
    <!--NEED TO KNOW-->
            ...
            <div class="container-fluid">
                ...
                <div class="row pt-1" style="margin: 2px 50px;" data-aos="zoom-in-down" data-aos-duration="2000">
                    ...
                    <div class="col-md-8">
                        <img src="../images/hot9.jpg" class="img-fluid" width="100%" height="50%">
...
<!--                        <div class="bottom-left">SUIT</div>-->
                    ...
                    <div class="col-md-8" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/hot10.jpg" class="img-fluid">
<!--                        <div class="bottom-left">OCEANVIEW</div>-->
                    </div>
