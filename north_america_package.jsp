...
<html>
  ...
  <div class="container-fluid image"  style="padding: 0px;">
      <img src="../images/North-America.jpg" class="img-fluid" width="100%" height="30%">
  </div>
  <!--BACK BUTTON-->
  <div class="container-fluid p-3" style="margin-left: 68px;">
      <a href="north_america.jsp">
...
Discover gorgeous beaches or the Pacific Northwest and explore diverse and sophisticated ports of call.
    ...
    <!--TAGLINE-->
    <div style="float:left; width: 40%;"><hr/></div>
<div style="float:right; width: 40%;"><hr/></div>
            ...
            <div class="container-fluid">
                <div class="row pt-5" style="margin: 3px 50px;">
                    ...
                    <div class="col-md-4 img" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/north_room(1).jpg" class="img-fluid">
                ...
                <div class="row pt-1" style="margin: 2px 50px;" data-aos="zoom-in-down" data-aos-duration="2000">
                    <div class="col-md-4">
                        <img src="../images/north_room(2).jpg" class="img-fluid" >
<!--                        <div class="bottom-left">SUIT</div>-->
                    </div>
                    <div class="col-md-8">
                        <img src="../images/north_room(3).jpg" class="img-fluid" width="100%" height="50%">
<!--                        <div class="bottom-left">OCEANVIEW</div>-->
                ...
                <div class="row pt-4" style="margin: 3px 50px;">
                    <div class="col-md-8" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/north_room(6).jpg" class="img-fluid">
<!--                        <div class="bottom-left">SUIT</div>-->
                    </div>
                    <div class="col-md-4" data-aos="zoom-in-down" data-aos-duration="2000">
                        <img src="../images/north_room(5).jpg" class="img-fluid">
<!--                        <div class="bottom-left">OCEANVIEW</div>-->
                    </div>
                </div>
            </div>
...
<!--last footer-->
    <div style="background-color: rgb(247, 182, 4);" class="p-3">
        <p style="margin-bottom: 0px;">© PearlCruiseLine - A division of Odyssey Vacations Pvt. Ltd. All rights reserved.  |  Sitemap  |  Privacy Policy</p></div>
